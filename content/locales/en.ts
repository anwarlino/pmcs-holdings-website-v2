...
export const en: LocaleContent = {
  ...
  contact: {
    ...
    cta: 'Continue to governance context',
    ctaNote: 'A calm pathway for institutional discussion; no form backend or contact endpoint is connected on this static site.',
    gatewayAria: 'Alignment inquiry gateway pathway showing documentation-led contact coordination steps',
    gatewayLabel: 'Alignment Inquiry Gateway',
    gatewayTitle: 'Structured contact pathway',
    gatewayBody: 'A concise route for counterparties to frame institutional discussion, validation needs and next-step coordination without implying solicitation or commitment.',
    pathway: [
      { title: 'Initial alignment', body: 'Clarify corridor relevance, counterparties and discussion boundaries.' },
      { title: 'Documentation review', body: 'Exchange information only where supporting records are available.' },
      { title: 'Partner validation', body: 'Confirm references and roles where applicable before representation.' },
      { title: 'Next-step coordination', body: 'Proceed only with appropriate approvals and final documentation.' },
    ],
    readiness: [
