    ...
    cards: [
      {
        ...
        body: 'A Singapore-led governance layer intended to support oversight discipline, documentation controls and claim-controlled institutional communication.',
        cta: 'View details',
      ...
      },
      {
        ...
        body: 'Thailand-based production readiness is presented as a planning pathway subject to site-level verification, operating controls and partner validation.',
        cta: 'View details',
      ...
      },
      {
        ...
        body: 'Sustainability controls and ICCR-aligned planning are under development and do not claim issued carbon credits, certification or completed regulatory approval.',
        cta: 'View details',
      ...
      {
        number: '04',
        eyebrow: 'Food-security corridor',
        title: 'GCC Food-Security Corridor',
        body: 'GCC engagement is framed as a food-security alignment concept, with market access, offtake and approvals subject to counterparties and final documentation.',
        cta: 'View details',
      ...
      },
      {
        ...
        body: 'Capital and partnership readiness focuses on documentation, diligence and validation; it does not represent secured financing, an investment offer or projected returns.',
        cta: 'View details',
