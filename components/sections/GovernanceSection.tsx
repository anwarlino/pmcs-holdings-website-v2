...
export function GovernanceSection({ dictionary }: { dictionary: LocaleContent }) {
  ...
  return (
    <section id="governance" className="relative overflow-hidden bg-[linear-gradient(180deg,#ffffff_0%,rgba(247,244,238,0.72)_48%,#ffffff_100%)] py-20 md:py-24">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_16%_18%,rgba(122,31,43,0.12),transparent_28%),radial-gradient(circle_at_84%_22%,rgba(179,139,74,0.14),transparent_30%),linear-gradient(rgba(122,31,43,0.035)_1px,transparent_1px),linear-gradient(90deg,rgba(122,31,43,0.035)_1px,transparent_1px)] bg-[length:auto,auto,44px_44px,44px_44px]" aria-hidden="true" />
      <div className="absolute inset-x-0 top-16 h-px bg-gradient-to-r from-transparent via-pmcs-gold/30 to-transparent" aria-hidden="true" />
      ...
      <div className="relative mx-auto max-w-7xl px-5">
        <div className="grid gap-10 lg:grid-cols-[0.78fr_1.22fr] lg:items-center">
          <div className="lg:pb-10">
            ...
            <aside className="mt-8 rounded-[2rem] border border-pmcs-gold/25 bg-white/75 p-5 shadow-[0_18px_55px_rgba(31,31,31,0.06)] backdrop-blur-sm">
              ...
              <p className="mt-3 text-sm leading-7 text-pmcs-muted md:text-base">{governance.disclosure}</p>
            </aside>
          </div>

          <div className="relative" aria-label={governance.frameworkAria}>
            <div className="absolute -inset-4 rounded-[3rem] bg-[radial-gradient(circle_at_65%_25%,rgba(179,139,74,0.20),transparent_33%),radial-gradient(circle_at_30%_78%,rgba(44,95,74,0.16),transparent_34%)] blur-xl" aria-hidden="true" />
            <div className="relative min-h-[520px] overflow-hidden rounded-[2.75rem] border border-white/80 bg-[linear-gradient(135deg,rgba(255,255,255,0.96),rgba(247,244,238,0.9)_46%,rgba(122,31,43,0.11))] p-5 shadow-[0_34px_95px_rgba(31,31,31,0.14)] md:p-8">
              <div className="absolute inset-0 bg-[linear-gradient(rgba(31,31,31,0.045)_1px,transparent_1px),linear-gradient(90deg,rgba(31,31,31,0.035)_1px,transparent_1px)] bg-[length:30px_30px] opacity-45" aria-hidden="true" />
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_28%_28%,rgba(255,255,255,0.72),transparent_24%),radial-gradient(circle_at_72%_62%,rgba(122,31,43,0.13),transparent_28%)]" aria-hidden="true" />

              <div className="absolute left-7 top-7 h-52 w-40 rotate-[-6deg] rounded-[1.4rem] border border-pmcs-line/80 bg-white/82 shadow-[0_24px_60px_rgba(31,31,31,0.10)]" aria-hidden="true">
              ...
              <div className="absolute bottom-12 right-10 h-56 w-44 rotate-[7deg] rounded-[1.5rem] border border-pmcs-gold/25 bg-white/70 shadow-[0_28px_70px_rgba(31,31,31,0.12)]" aria-hidden="true">
              ...
              <div className="relative flex min-h-[480px] flex-col justify-between">
                <div className="grid gap-3 md:max-w-[56%]">
                  {overlayControls.slice(0, 3).map((node, index) => (
                    <div key={`${node.title}-workflow`} className="flex items-center gap-3 rounded-full border border-white/80 bg-white/78 px-4 py-3 text-sm font-bold text-pmcs-charcoal shadow-sm backdrop-blur-sm">
                      <span className="h-2.5 w-2.5 shrink-0 rounded-full bg-pmcs-green ring-4 ring-pmcs-green/12" aria-hidden="true" />
                      <span className="min-w-0 truncate">{node.title}</span>
                      <span className="ms-auto text-[0.66rem] font-black uppercase tracking-[0.18em] text-pmcs-gold">{String(index + 1).padStart(2, '0')}</span>
                    </div>
                  ))}
                </div>

                <div className="absolute left-[32%] top-[38%] hidden h-px w-[34%] -rotate-12 bg-gradient-to-r from-pmcs-maroon/5 via-pmcs-maroon/30 to-pmcs-green/10 md:block" aria-hidden="true" />
                <div className="absolute left-[34%] top-[48%] hidden h-px w-[42%] rotate-6 bg-gradient-to-r from-pmcs-gold/10 via-pmcs-gold/38 to-pmcs-maroon/10 md:block" aria-hidden="true" />
                ...
                <div className="relative mt-auto rounded-[2rem] border border-pmcs-maroon/15 bg-pmcs-maroon/95 p-6 text-white shadow-[0_28px_80px_rgba(122,31,43,0.24)] backdrop-blur-sm md:ms-auto md:w-[62%] md:p-7">
                  ...
                  <p className="mt-3 text-sm leading-6 text-white/80">{governance.central.body}</p>

                  <div className="mt-5 grid gap-2 sm:grid-cols-2">
                    {overlayControls.map((node, index) => (
                      <div key={`${node.title}-overlay`} className="flex items-center gap-2 rounded-2xl border border-white/10 bg-white/8 px-3 py-2 text-xs font-bold text-white/90">
                        <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-white/10 text-pmcs-gold" aria-hidden="true">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-center text-xs font-semibold uppercase tracking-[0.16em] text-pmcs-muted/75">{governance.visualCaption}</p>
          </div>
        </div>
        ...
        <div className="mt-12 rounded-[2.5rem] border border-white/80 bg-white/82 p-5 shadow-[0_24px_70px_rgba(31,31,31,0.08)] backdrop-blur-sm md:p-7">
          <div className="flex flex-col gap-3 border-b border-pmcs-line pb-5 md:flex-row md:items-end md:justify-between">
            ...
            <span className="h-px flex-1 bg-gradient-to-r from-pmcs-gold/40 via-pmcs-green/15 to-transparent md:ms-6" aria-hidden="true" />
          </div>
          <div className="mt-6 grid gap-x-8 gap-y-4 md:grid-cols-2">
            {governance.controls.map((control) => (
              <div key={control} className="group flex gap-4 rounded-[1.35rem] border border-transparent p-3 transition duration-200 hover:border-pmcs-gold/25 hover:bg-pmcs-light/60 motion-reduce:transition-none">
                <span className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-pmcs-green/20 bg-pmcs-green/10 text-pmcs-green" aria-hidden="true">
                ...
                <p className="text-sm font-semibold leading-6 text-pmcs-charcoal md:text-[0.95rem]">{control}</p>
              </div>
            ))}
          </div>
        </div>
