  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden="true"
      />
      <div className="pointer-events-none absolute inset-0 z-[1] bg-[linear-gradient(90deg,rgba(255,255,255,0.30)_0%,rgba(255,255,255,0.18)_45%,rgba(255,255,255,0.12)_100%)]" />
      <div className="pointer-events-none absolute inset-0 z-[2] bg-[linear-gradient(90deg,rgba(43,43,43,0.025)_1px,transparent_1px),linear-gradient(180deg,rgba(43,43,43,0.02)_1px,transparent_1px)] bg-[size:4.5rem_4.5rem] opacity-40" />
